...
def define_flags():
  ...
  # Alpha Invariance Flags
  flags.DEFINE_float(
      "distance_scale", 1.0,
      "distance scaling on interval lengths"
  )
  flags.DEFINE_float(
      "gamma", 1.0,
      "gamma value used to inversely scale raw output of density network"
  )
  ...
  flags.DEFINE_integer(
      "render_every", 200000, "the number of steps to render a test image,"
...
def update_flags(args):
  ...
  pth = path.join("/share/data/2pals/jjahn/exp/nerf-pytorch/2024/jaxnerf/configs", args.config)
...
# taken directly from camp_zipnerf here: https://github.com/jonbarron/camp_zipnerf/blob/16206bd88f37d5c727976557abfbd9b4fa28bbe1/internal/math.py#L215
